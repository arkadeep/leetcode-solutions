# Last updated: 4/9/2025, 12:35:52 AM
# Had to take help from neetcode. Very interesting problem. The key intuition here is to traverse the array in descending order of car position. Once a faster car catches up, then they are a fleet. There is no overtaking involved.
class Solution:
